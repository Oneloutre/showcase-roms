...
official_devices = {
    "Xiaomi Mi Mix 2S": {"codename": "polaris", "image": "https://github.com/Evolution-X/www_gitres/blob/main/devices/images/polaris.png?raw=true", "download": "https://sourceforge.net/projects/evolution-x/files/polaris"},
    "Google Pixel 3a": {"codename": "sargo", "image": "https://github.com/Evolution-X/www_gitres/blob/main/devices/images/sargo.png?raw=true", "download": "https://sourceforge.net/projects/evolution-x/files/sargo"},
    "Google Pixel 3a XL": {"codename": "bonito", "image": "https://github.com/Evolution-X/www_gitres/blob/main/devices/images/bonito.png?raw=true", "download": "https://sourceforge.net/projects/evolution-x/files/bonito"},
    "Google Pixel 3": {"codename": "blueline", "image": "https://github.com/Evolution-X/www_gitres/blob/main/devices/images/blueline.png?raw=true", "download": "https://sourceforge.net/projects/evolution-x/files/blueline"},
    "Google Pixel 3 XL": {"codename": "crosshatch", "image": "https://github.com/Evolution-X/www_gitres/blob/main/devices/images/crosshatch.png?raw=true", "download": "https://sourceforge.net/projects/evolution-x/files/crosshatch"},
}
